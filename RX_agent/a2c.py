...
model.learn(total_timesteps=50000, tb_log_name="second_run", reset_num_timesteps=False) 
model.learn(total_timesteps=50000, tb_log_name="third_run", reset_num_timesteps=False) 
